...
import {NewsHttpServiceDefinition} from './news.http-service';
...
@Injectable()
export class NewsHttpServiceMock implements NewsHttpServiceDefinition {
  getNews(): Observable<News[]> {
    return of(Newsitems);
  }

  getNewsDetail(id: string): Observable<News> {
    return of(Newsitems.find(n => n.id === id));
  }
